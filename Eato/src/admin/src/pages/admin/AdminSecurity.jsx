  ...
  return (
    <div className="max-w-2xl">
      ...
      <p className="mb-6 text-sm text-stone-600">
        ...
        <code className="rounded bg-stone-200 px-1 text-xs">/api/admin/*</code>. Customers and restaurants receive separate tokens and cannot access admin routes.
      </p>
      <ul className="list-inside list-disc space-y-2 text-sm text-stone-700">
        <li>Store JWTs securely; the admin app keeps the token in <code className="text-xs">localStorage</code> for this prototype.</li>
